...
<body>
            ...
            <div class="udlite-text-sm clp-lead">
                  ...
                  <a href="javascript:void(0);" class="styles--rating-wrapper--5a0Tr">
                    ...
                    <span class="star-rating--star-wrapper--1QyBg star-rating--medium--17tJo star-rating--dark-background--3tENo">
                      ...
                      <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 70 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g class="star-rating--star-filled--24lmQ" mask="url(#u152-star-rating-mask--28)" data-purpose="star-filled">
                        ...
                        <g fill="transparent" class="star-rating--star-bordered--1EkpX" stroke-width="2" data-purpose="star-bordered">
              ...
              <div class="clp-lead__element-item">
                ...
                <div class="instructor-links--instructor-links--3d8_F">
                  <span class="udlite-text-sm">建立者：</span>
                  
                  <a class="udlite-btn udlite-btn-large udlite-btn-link udlite-heading-md udlite-text-sm udlite-instructor-links" data-position="1" href="#instructor-1">
                    <span>${instructor.getMemberInformation().getFullname()}</span>
                  </a>
                </div>
              </div>
              ...
              <div class="clp-lead__element-meta">
                <div class="clp-lead__element-item clp-lead__locale">
                  <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-xsmall icon"><use xlink:href="#icon-language"></use></svg>
                  Traditional Chinese
                </div>
              </div>
            </div>
      ...
      <div class="course-landing-page__main-content">
        ...
        <div class="component-margin what-you-will-learn--what-will-you-learn--mnJ5T">
          ...
          <div class="what-you-will-learn--content-spacing--3btHJ">
            ...
            <ul class="unstyled-list udlite-block-list what-you-will-learn--objectives-list--2cWZN">
              ...
              <c:if test = "${not empty classBean.getClassDetailsBean().getGoal().trim().split(re)}">
                <c:forEach var="goal" items="${classBean.getClassDetailsBean().getGoal().trim().split(re)}">
                  <c:if test = "${not empty goal}">
                    <li>
                      <div class="udlite-block-list-item udlite-block-list-item-small udlite-block-list-item-tight udlite-block-list-item-neutral udlite-text-sm">
                        <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-xsmall udlite-icon-color-neutral udlite-block-list-item-icon"><use xlink:href="#icon-tick"></use></svg>
        ...
        <div class="component-margin">
          ...
          <div class="course-curriculum">
            ...
            <div class="curriculum--curriculum-sub-header--3_-6E">
              <div class="udlite-text-sm">
                <span class="curriculum--content-length--1XzLS">
                  ${classBean.getCurriculumbean().size()} 個章節 • ${classBean.getCurriculumbean().size() * 10 + 2} 堂講座 • 
                  <span>總長度：<span>${classBean.getCurriculumbean().size()}&nbsp;小時&nbsp;49&nbsp;分</span></span>
                </span>
              </div>
            </div>
            ...
            <div>
              <!-- section panel block -->
              <c:forEach var="curriculum" items="${classBean.getCurriculumbean()}" varStatus="loop">
              <div class="section--panel--1tqxC panel--panel--3uDOH">
                ...
                <div data-bs-toggle="collapse" 
                  ...
                  <div class="udlite-btn udlite-btn-large udlite-btn-link udlite-heading-md udlite-accordion-panel-toggler panel--panel-toggler--30J_B panel--outer-panel-toggler--3I6w6">
                    <!-- accordion panel heading -->
                    <h3 class="udlite-accordion-panel-heading">
                      <button class="udlite-btn udlite-btn-large udlite-btn-link udlite-heading-md js-panel-toggler panel--panel-toggler--30J_B">
                        <span class="udlite-accordion-panel-title">
                          <span class="section--section-title--8blTh">${curriculum.getChapter()}</span>
                          <span class="udlite-text-sm section--hidden-on-mobile--171Q9 section--section-content--9kwnY" 
                                data-purpose="section-content">
                                ${curriculum.getCuid() % 10 + 2} 堂講座 • <span>${curriculum.getCuid() % 10 * 5 + 30} 分鐘</span>
                          </span>
                        </span>
                      </button>
                    </h3>
                    
                    <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-small udlite-icon-color-neutral panel--expand-icon--1ZzXo"><use xlink:href="#icon-expand"></use></svg>
                  </div>
                </div>
              
                <!-- hidden panel content wrapper (bootstrap collapse toggle) -->
                <div id="collapse${curriculum.getCuid()}" class="collapse panel--content-wrapper--1g5eE">
                  <!-- hidden panel content -->
                  <div class="udlite-accordion-panel-content panel--content--2q9WW">
                    <ul class="unstyled-list udlite-block-list">
                      <c:forEach var="x"  begin="1" end="${curriculum.getCuid() % 10 + 2}">
                        <li>
                          <!-- section preview item -->
                          <div class="udlite-block-list-item udlite-block-list-item-small udlite-text-sm">
                            <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-xsmall udlite-icon-color-neutral udlite-block-list-item-icon"><use xlink:href="#icon-play"></use></svg>
                            ...
                            <div class="udlite-block-list-item-content">
                              ...
                              <span class="section--hidden-on-mobile--171Q9" style="flex: 1 1 0%;"></span>
                              <span class="section--hidden-on-mobile--171Q9 section--item-content-summary--126oS">${curriculum.getCuid() % x + 11}:00</span>
                            </div>
                          </div>
                        </li>
                      </c:forEach>
        ...
        <c:set var="re" value="\\d+\\." />
        <c:if test = "${not empty classBean.getClassDetailsBean().getStu_required().trim().split(re)}">
        <!-- "要求" block -->
          <div class="component-margin">
            <h2 class="udlite-heading-xl requirements--title--2j7S2" style="margin-bottom: 1.6rem;">要求</h2>
            <ul class="unstyled-list udlite-block-list">
              <c:forEach var="require" items="${classBean.getClassDetailsBean().getStu_required().trim().split(re)}">
                <c:if test = "${not empty require}">
                  <li>
                    <div class="udlite-block-list-item udlite-block-list-item-small udlite-block-list-item-tight udlite-block-list-item-neutral udlite-text-sm">
                      <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-xsmall udlite-icon-color-neutral udlite-block-list-item-icon"><use xlink:href="#icon-bullet"></use></svg>
        ...
        <c:set var="re" value="\\d+\\." />
        <c:if test = "${not empty classBean.getClassDetailsBean().getNeeded_tool().trim().split(re)}">
        <!-- "工具" block -->
          <div class="component-margin">
            <h2 class="udlite-heading-xl requirements--title--2j7S2" style="margin-bottom: 1.6rem;">工具</h2>
            <ul class="unstyled-list udlite-block-list">
              <c:forEach var="tool" items="${classBean.getClassDetailsBean().getNeeded_tool().trim().split(re)}">
        ...
        <!-- "講師" block -->
        <div class="component-margin styles--instructors--2JsS3" style="flex-direction: column;">
          <h2 class="udlite-heading-xl styles--instructors__header--16F_8" style="margin: 0 0 1.6rem;">講師</h2>
          
          <!-- instructor block -->
          <div class="instructor--instructor--1wSOF">
            <div>
              <!-- instructor title -->
              <div class="udlite-heading-lg udlite-link-underline instructor--instructor__title--34ItB">
                <a href="javascript:void(0);" style="color: #5fcf80;">${instructor.getMemberInformation().getFullname()}</a>
              </div>
              
              <!-- instructor job -->
              <div class="udlite-text-md instructor--instructor__job-title--1HUmd">${instructor.getMemberInformation().getJob()}</div>
            </div>
            
            <!-- instructor image and states block -->
            <div class="instructor--instructor__image-and-stats--1IqE7">
              <!-- instructor image link -->
              <a class="instructor--instructor__image-link--9e3fA">
                <!-- instructor avatar -->
                <img alt="Frank BAI" class="instructor--instructor__image--va-P5 udlite-avatar udlite-avatar-image" width="64" height="64" 
              ...
              <ul class="unstyled-list udlite-block-list">
                <li>
                  <div class="udlite-block-list-item udlite-block-list-item-small udlite-block-list-item-tight udlite-block-list-item-neutral udlite-text-sm"
                   ...
                   >
                    <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-xsmall udlite-icon-color-neutral udlite-block-list-item-icon"><use xlink:href="#icon-rating-star"></use></svg>
                    <div class="udlite-block-list-item-content" style="min-height: 1.96rem; margin-left: 1.6rem;">講師評等 0.0</div>
                  </div>
                </li>
                ...
                <li>
                  <div class="udlite-block-list-item udlite-block-list-item-small udlite-block-list-item-tight udlite-block-list-item-neutral udlite-text-sm"
                       style="padding: 0.4rem 0;"
                  >
                    <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-xsmall udlite-icon-color-neutral udlite-block-list-item-icon"><use xlink:href="#icon-certificate"></use></svg>
                    <div class="udlite-block-list-item-content" style="min-height: 1.96rem; margin-left: 1.6rem;">0 則評論</div>
                  </div>
                </li>
                ...
                <li>
                  <div data-purpose="stat" class="udlite-block-list-item udlite-block-list-item-small udlite-block-list-item-tight udlite-block-list-item-neutral udlite-text-sm"
                       style="padding: 0.4rem 0;"
                  >
                    <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-xsmall udlite-icon-color-neutral udlite-block-list-item-icon"><use xlink:href="#icon-people"></use></svg>
                    <div class="udlite-block-list-item-content" style="min-height: 1.96rem; margin-left: 1.6rem;">0 位學生</div>
                  </div>
                </li>
                ...
                <li>
                  ...
                  >
                    <svg aria-hidden="true" focusable="false" class="udlite-icon udlite-icon-xsmall udlite-icon-color-neutral udlite-block-list-item-icon"><use xlink:href="#icon-play"></use></svg>
                    <div class="udlite-block-list-item-content" style="min-height: 1.96rem; margin-left: 1.6rem;">0 門課程</div>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div class="udlite-text-sm instructor--instructor__description--1dHxF" style="margin-top: 1.6rem; margin-bottom: 0.8rem;">
              <div class="show-more--container--3W59b">
                <div class="show-more--content--2BLF7" style="max-height: 14.6rem;">
                  <div>
                    <div>
                      <p>
                        具有相當豐富的業界實戰與教學經驗，曾參與連鎖3C通訊零售商、電子商務、行動支付等多間國內知名上市公司，打造多款行動應用程式。
                        老師總是不藏私，經常分享獨家珍藏心得筆記，在 Facebook、Youtube、Dcard 和 Ptt 等社群媒體跟大家分享交流最新技術文章，
                        帶給大家第一手的完整新技術、讓大家的知識與產業界實際應用層面上確切接軌。
                      </p>
                    </div>
                  </div>
                </div>
  ...
  <svg
    ...
    <defs>
      ...
      <symbol id="icon-trophy" viewBox="0 0 24 24"><path d="M19 5h-2V3H7v2H5c-1.1 0-2 .9-2 2v1c0 2.55 1.92 4.63 4.39 4.94A5.01 5.01 0 0011 15.9V19H7v2h10v-2h-4v-3.1a5.01 5.01 0 003.61-2.96C19.08 12.63 21 10.55 21 8V7c0-1.1-.9-2-2-2zM5 8V7h2v3.82C5.84 10.4 5 9.3 5 8zm7 6c-1.65 0-3-1.35-3-3V5h6v6c0 1.65-1.35 3-3 3zm7-6c0 1.3-.84 2.4-2 2.82V7h2v1z"></path></symbol>
    </defs>
  </svg>
</body>
