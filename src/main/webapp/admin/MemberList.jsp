...
<td>
<input type="button" onclick="javascript:location.href='/SpecialTopic/admin/MemberDelete?username=<%= mb.getUsername() %>'" value="刪除">
<input type="button" onclick="javascript:location.href='/SpecialTopic/MemberFunction/MemberInfo.jsp?username=<%= mb.getUsername() %>'" value="修改">
</td>
</tr>
<% } %>
</tbody>
